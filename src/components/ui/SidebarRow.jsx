...
const SidebarRow = ({page, activePage, updateFavorite}) => {
    ...
    <div className={clsx(
          ...
          active ? 'bg-zinc-400' : 'hover:bg-zinc-300'
        )}
      ...
      <svg
          className={clsx(
            'w-5 h-5 mr-1 mt-0.5 cursor-pointer',
            {
              ...
              'text-stone-200': !favorite && !active && !hoverOnNote,
              'text-zinc-300': !favorite && !active && hoverOnNote,
              'text-zinc-400': !favorite && active,
            },
